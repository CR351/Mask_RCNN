"""
Mask R-CNN
Configurations and data loading code for CVPR 2018.
...
class CVPRConfig(Config):
    """Configuration for training on CVPR.
    ...
    NUM_CLASSES = 1 + 35  # CVPR has 35 classes ( Might be 34 if unknown = background)
...
class CVPRDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
        ...
        """Load a subset of the CVPR dataset.
        dataset_dir: The root directory of the CVPR dataset.
        subset: What to load (train, val, minival, valminusminival)
        year: What dataset year to load (2014, 2017) as a string, not an integer
        class_ids: If provided, only loads images that have the given classes.
        class_map: TODO: Not implemented yet. Supports maping classes from
                          different datasets to the same class ID.
        return_coco: If True, returns the CVPR object.
        auto_download: Automatically download and unzip CVPR images and annotations
        """
